...
if(!dojo._hasResource['client.components.Twitter']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['client.components.Twitter'] = true;
dojo.provide('client.components.Twitter');


mulberry.component('Twitter', {
  componentTemplate : dojo.cache("client.components", "Twitter/Twitter.haml", "%ul.component.twitter\n"),
